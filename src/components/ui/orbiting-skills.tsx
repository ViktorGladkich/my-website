...
export default function OrbitingSkills() {
  ...
  return (
    <div className="w-full flex items-center justify-center overflow-hidden min-h-[400px]">
      {/* Background pattern */}
      ...
      >
        ...
        <div className="w-20 h-20 bg-linear-to-br from-gray-700 to-gray-900 rounded-full flex items-center justify-center z-10 relative shadow-2xl border border-white/10">
