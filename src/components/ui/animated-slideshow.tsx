...
import { HTMLMotionProps, MotionConfig, motion } from "framer-motion"; // Changed to framer-motion since it's standard in Next.js projects usually
...
interface HoverSliderProps {
  className?: string; // Add explicit className optional prop to avoid empty object type
}
